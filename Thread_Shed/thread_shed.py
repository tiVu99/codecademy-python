...
for trans in daily_transactions_split:
  for each_tran in trans:
    transactions_clean.append(each_tran.strip())
...
for x in range(0, len(transactions_clean), 4):
  customers.append(transactions_clean[x])
  sales.append(transactions_clean[x+1])
  thread_sold.append(transactions_clean[x+2])
...
for thread in thread_sold:
  if thread.find('&') == -1:
    ...
    for each_thread in thread:
      thread_sold_split.append(each_thread)
